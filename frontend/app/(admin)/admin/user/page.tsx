      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl shadow-xl px-6 space-y-6">
            {/* MODAL HEADER */}
            <div className="flex justify-between items-center border-b border-slate-100 py-4 sticky top-0 bg-white z-10">
              <div>
              ...
              <button
                onClick={resetForm}
                className="text-gray-400 hover:text-gray-600 text-lg transition cursor-pointer"
              >
                ✕
              </button>
            </div>
            ...
            {/* MODAL ACTIONS */}
            <div className="flex justify-end gap-3 py-4 border-t border-slate-100 sticky bottom-0 bg-white z-10">
              <button
                type="button"
                onClick={resetForm}
                className="px-4 py-2 text-xs font-semibold border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 transition cursor-pointer"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="bg-amber-900 hover:bg-amber-950 text-white text-xs font-semibold px-5 py-2 rounded-lg transition cursor-pointer"
              >
